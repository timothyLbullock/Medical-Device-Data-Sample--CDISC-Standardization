...
/*---------------------------------------------------------------------
  2. Generate DX Domain, Dropping Interim Variables
---------------------------------------------------------------------*/
data work.DX(
...
/*---------------------------------------------------------------------
  4. Export DX, defds, defvar to SAS Transport files
---------------------------------------------------------------------*/
libname xptout xport '/home/u64270181/Clinical/Data/dx.xpt';
proc copy in=work out=xptout memtype=data;
  select DX;
run;
libname xptout clear;
libname xptout xport '/home/u64270181/Clinical/Data/dx_defs.xpt';
proc copy in=work out=xptout memtype=data;
  select defds defvar;
run;
libname xptout clear;
